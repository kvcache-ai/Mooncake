...
class RingAllReduceProtocol {
   public:
    ...
    RingAllReduceProtocol& operator=(const RingAllReduceProtocol&) =
        delete;
    ...
    [[nodiscard]] const RingAllReduceEndpoint& localEndpoint()
        const noexcept;
   ...
   private:
    ...
    RingAllReduceProtocol(
        ...
        DeviceArenaSlice signals, RingSignalLayout signal_layout) noexcept;
