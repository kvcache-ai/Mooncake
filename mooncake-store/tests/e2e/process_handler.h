...
public:
	 ...
	 */
	MasterProcessHandler(const std::string &path, const std::string &etcd_endpoints, const int port, const int index,
...
public:
	 ...
	 * @param out_dir The directory to store the log files.
	 */
	ClientProcessHandler(const std::string &path, const int index, const std::string &out_dir,
