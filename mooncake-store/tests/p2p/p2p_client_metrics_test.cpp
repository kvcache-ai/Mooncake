...
class P2PClientMetricsTest : public ::testing::Test {
   protected:
    void SetUp() override {
        google::InitGoogleLogging("P2PClientMetricsTest");
        FLAGS_logtostderr = true;
    }
    void TearDown() override { google::ShutdownGoogleLogging(); }
};

TEST_F(P2PClientMetricsTest, P2PClientMetricBasicTest) {
...
TEST_F(P2PClientMetricsTest, P2PClientMetricSerializeTest) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, P2PClientMetricWithLabelsTest) {
...
TEST_F(P2PClientMetricsTest, P2PClientMetricPeerRequestTest) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, P2PClientMetricBothLocalAndPeerTest) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, P2PClientMetricCreateReturnsInstance) {
    auto p2p_metrics = P2PClientMetric::Create({});
    EXPECT_NE(p2p_metrics, nullptr);
    EXPECT_EQ(p2p_metrics->GetReportingInterval(), 0u);
}

TEST_F(P2PClientMetricsTest, DataMetricRecordGetSemanticsTest) {
...
TEST_F(P2PClientMetricsTest, BuildSyncSnapshotGoldenValues) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, DataMetricRecordPutSemanticsTest) {
    DataMetric dm("mooncake_p2p_test");
...
TEST_F(P2PClientMetricsTest, P2PClientMetricRetryCountersTest) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, TierMetricEmptyTest) {
    TierMetric metric;
...
TEST_F(P2PClientMetricsTest, TierMetricRegisterAndCountTest) {
    TierMetric metric;
...
TEST_F(P2PClientMetricsTest, TierMetricUnregisteredTierTest) {
    TierMetric metric;
...
TEST_F(P2PClientMetricsTest, TierMetricExpiredTierKeepsLastUsageTest) {
    TierMetric metric;
...
TEST_F(P2PClientMetricsTest, TierMetricDuplicateRegistrationTest) {
    TierMetric metric;
...
TEST_F(P2PClientMetricsTest, P2PClientMetricTierSectionTest) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, TierMetricMovementCountersTest) {
    TierMetric metric;
    const UUID high{1, 1};
    const UUID low{2, 2};
...
TEST_F(P2PClientMetricsTest, KeyRetentionCountsAndSnapshot) {
...
TEST_F(P2PClientMetricsTest, KeyRetentionRemovalRecordsLifetime) {
    using Clock = std::chrono::steady_clock;
    const auto anchor = Clock::now() - std::chrono::seconds(1000);
    KeyRetentionMetric metric("test_retention", {}, anchor);
...
TEST_F(P2PClientMetricsTest, KeyRetentionClampsNegativeLifetime) {
    using Clock = std::chrono::steady_clock;
...
TEST_F(P2PClientMetricsTest, KeyRetentionConcurrentHooksStayConsistent) {
    using Clock = std::chrono::steady_clock;
    KeyRetentionMetric metric("test_retention", {});
...
TEST_F(P2PClientMetricsTest, KeyRetentionSerializeAndSummary) {
    using Clock = std::chrono::steady_clock;
    const auto anchor = Clock::now() - std::chrono::seconds(1000);
    KeyRetentionMetric metric("test_retention", {}, anchor);
...
TEST_F(P2PClientMetricsTest, SerializeBucketHistogramFormat) {
...
TEST_F(P2PClientMetricsTest, BuildSyncSnapshotIncludesKeyRetention) {
    P2PClientMetric metrics;
...
TEST_F(P2PClientMetricsTest, ClientMetricSnapshotStructPackRoundTrip) {
