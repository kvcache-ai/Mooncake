...
class HAMetricManagerTest : public ::testing::Test {
   protected:
    ...
    P2PHAMetricManager& M() { return P2PHAMetricManager::instance(); }
};
...
TEST_F(HAMetricManagerTest, TestSingletonInstance) {
    P2PHAMetricManager& a = P2PHAMetricManager::instance();
    P2PHAMetricManager& b = P2PHAMetricManager::instance();
...
TEST_F(HAMetricManagerTest, TestConcurrentAccess) {
    ...
    auto& mgr = P2PHAMetricManager::instance();
