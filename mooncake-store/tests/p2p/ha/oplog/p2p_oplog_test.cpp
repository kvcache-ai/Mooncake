...
TEST(P2POpLogTypesTest, RoundTrip_RegisterClientPayload) {
    ...
    seg.name = "seg_001";
    seg.size = 1024;
    seg.p2p_extra = P2PSegmentExtraData{1, {"tag1"}, MemoryType::DRAM, 0};
...
TEST(P2POpLogTypesTest, RoundTrip_RegisterClientPayload_MultipleSegments) {
    ...
    seg1.name = "dram_seg";
    seg1.size = 4096;
    seg1.p2p_extra = P2PSegmentExtraData{2, {"ssd", "gpu"}, MemoryType::DRAM, 512};

    Segment seg2;
    seg2.id = {3, 4};
    seg2.name = "nvme_seg";
    seg2.size = 8192;
    seg2.p2p_extra = P2PSegmentExtraData{3, {"nvme"}, MemoryType::NVME, 1024};
