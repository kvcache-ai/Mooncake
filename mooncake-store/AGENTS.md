...
- Production code in `include/`, `client/`, `master/`, and `common/` must use
  `include/common/random.h`; do not create random engines, seeds, or distributions at
  call sites.
...
- Do not migrate `common/cachelib_memory_allocator/` unless explicitly requested.
