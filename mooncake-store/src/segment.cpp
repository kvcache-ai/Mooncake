...
ErrorCode ScopedSegmentAccess::ReMountSegment(const std::vector<Segment>& segments,
...
ErrorCode ScopedSegmentAccess::GetClientSegments(const UUID& client_id, std::vector<UUID>& segments) const {
...
ErrorCode ScopedSegmentAccess::QuerySegments(const std::string& segment, size_t& used,
                                       size_t& capacity) {
