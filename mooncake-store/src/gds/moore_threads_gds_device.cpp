...
class MooreThreadsGdsDeviceOps final : public GdsDeviceOps {
   public:
...
std::unique_ptr<GdsDeviceOps> CreateMooreThreadsGdsDeviceOps() {
    return std::make_unique<MooreThreadsGdsDeviceOps>();
}
