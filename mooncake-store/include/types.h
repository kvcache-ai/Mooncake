...
static constexpr double DEFAULT_SIZE_CLASS_FREE_RATIO_WEIGHT = 1.0;
static constexpr double DEFAULT_SIZE_CLASS_MATCHING_SHARE_WEIGHT = 0.15;
...
enum class AllocationStrategyType {
    ...
    SIZE_CLASS_AWARE       // Size-class-aware segment affinity
};
