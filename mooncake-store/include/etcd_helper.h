...
public:
	 ...
	 * @return: Error code.
	 */
	static ErrorCode Get(const char *key, const size_t key_size, std::string &value, EtcdRevisionId &revision_id);
	 ...
	 * @return: Error code.
	 */
	static ErrorCode CreateWithLease(const char *key, const size_t key_size, const char *value, const size_t value_size,
	                                 EtcdLeaseId lease_id, EtcdRevisionId &revision_id);
