...
// Shared master-side metrics and serialization/summary/reset machinery.
// Architecture-specific metrics live in CentralizedMasterMetricManager
// and P2PMasterMetricManager.
