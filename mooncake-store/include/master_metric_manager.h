...
class MasterMetricManager {
   public:
    ...
    void inc_fit_aware_fallback_requests(int64_t val = 1);
    void inc_fit_aware_eligible_candidates_checked(int64_t val = 1);
    void inc_fit_aware_no_fit_budget_credits(int64_t val = 1);
    void inc_fit_aware_segment_allocate_calls(int64_t val = 1);
    void inc_fit_aware_recovered_allocations(int64_t val = 1);
    void inc_fit_aware_chargeable_budget_exhaustions(int64_t val = 1);
    void inc_fit_aware_scan_cap_exhaustions(int64_t val = 1);
    void observe_fit_aware_positions_scanned(int64_t val);
    void observe_fit_aware_chargeable_positions(int64_t val);
    void observe_fit_aware_no_fit_budget_credits(int64_t val);
    ...
    int64_t get_fit_aware_fallback_requests();
    int64_t get_fit_aware_eligible_candidates_checked();
    int64_t get_fit_aware_no_fit_budget_credits();
    int64_t get_fit_aware_segment_allocate_calls();
    int64_t get_fit_aware_recovered_allocations();
    int64_t get_fit_aware_chargeable_budget_exhaustions();
    int64_t get_fit_aware_scan_cap_exhaustions();
   ...
   private:
    ...
    ylt::metric::counter_t fit_aware_fallback_requests_;
    ylt::metric::counter_t fit_aware_eligible_candidates_checked_;
    ylt::metric::counter_t fit_aware_no_fit_budget_credits_;
    ylt::metric::counter_t fit_aware_segment_allocate_calls_;
    ylt::metric::counter_t fit_aware_recovered_allocations_;
    ylt::metric::counter_t fit_aware_chargeable_budget_exhaustions_;
    ylt::metric::counter_t fit_aware_scan_cap_exhaustions_;
    ylt::metric::histogram_t fit_aware_positions_scanned_;
    ylt::metric::histogram_t fit_aware_chargeable_positions_;
    ylt::metric::histogram_t fit_aware_no_fit_budget_credits_distribution_;
