...
#define FOLLY_DISABLE_ADDRESS_SANITIZER __attribute__((__no_sanitize__("address"), __noinline__))
#elif __has_attribute(__no_address_safety_analysis__)
#define FOLLY_DISABLE_ADDRESS_SANITIZER __attribute__((__no_address_safety_analysis__, __noinline__))
...
#if defined(FOLLY_SANITIZE_ADDRESS) || defined(FOLLY_SANITIZE_THREAD) || defined(FOLLY_SANITIZE_MEMORY) ||             \
    defined(FOLLY_SANITIZE_DATAFLOW) || defined(FOLLY_SANITIZE_UNDEFINED_BEHAVIOR)
