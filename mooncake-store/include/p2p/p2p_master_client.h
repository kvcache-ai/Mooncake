...
class P2PMasterClient : public MasterClientInterface {
   public:
     ...
     */
    [[nodiscard]] tl::expected<void, ErrorCode> Connect(
     ...
     */
    [[nodiscard]] CacheStats CalcCacheStats() override;
     ...
     */
    [[nodiscard]] tl::expected<std::vector<Replica>, ErrorCode>
   ...
   private:
     ...
     * @tparam ServiceMethod Pointer to WrappedP2PMasterService member function
