...
namespace mooncake {
    ...
    class ClientTaskManager {
        public:
            ...
            UUID submit_task(const std::string& localhost_name, TaskType type, const std::string& payload);
            ...
            void mark_failed(const std::string& localhost_name, const UUID& task_id, const std::string& error_message);
