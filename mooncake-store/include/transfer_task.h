...
class TransferEngineOperationState : public OperationState {
   public:
    ...
    void set_result(ErrorCode error_code);

    void wait_for_completion() override;

    /**
     * @brief Check the current completion status of the task
     * @return TaskCompletionStatus indicating current state
     */
