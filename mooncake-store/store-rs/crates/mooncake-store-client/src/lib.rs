...
pub use observability::{
    ...
    record_tenant_local_eviction, record_tenant_quota_reconcile, render_breakdown_json,
    render_prometheus_metrics, render_stats_json, snapshot_metrics, start_metrics_http_server,
