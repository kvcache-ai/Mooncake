...
class RecoveryTestAbort(Exception):
    pass
...
def main() -> int:
    ...
    try:
        ...
        if not initial_roundtrip["passed"]:
            raise RecoveryTestAbort("initial put/get/remove roundtrip failed")
    ...
    except RecoveryTestAbort as exc:
        report["aborted"] = True
