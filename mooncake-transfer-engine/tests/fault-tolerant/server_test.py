...
def main():
    ...
    server_engine = MooncakeTransferEngine(
        hostname="localhost:10010", gpu_id=0, ib_device=None  # Using GPU 0  # No specific IB device
    )
    ...
    buffer_info = {"session_id": server_engine.get_session_id(), "ptr": server_ptr, "len": server_len}
