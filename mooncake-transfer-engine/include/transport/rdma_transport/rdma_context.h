...
class RdmaContext {
   ...
   public:
    ...
    bool autoGidSelectionEnabled() const {
        return auto_gid_selection_enabled_;
    }

    bool reprobeAutoGid(const GidSelectionSnapshot &expected_selection,
                        const std::vector<AutoGidSelectionIdentity>
                            &tried_selections = {},
