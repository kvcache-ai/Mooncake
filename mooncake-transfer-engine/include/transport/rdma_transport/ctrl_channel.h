...
// typed CtrlFrames. Owned by RdmaTransport; not part of EndpointStore.
class CtrlChannel {
   public:
    using NotifyDesc = TransferMetadata::NotifyDesc;
    using HandShakeDesc = TransferMetadata::HandShakeDesc;

    CtrlChannel(RdmaTransport &transport, RdmaContext &context,
    ...
    int acceptPassive(const HandShakeDesc &peer_desc, HandShakeDesc &local_desc);
    ...
    // Poll notify CQ; dispatch inbound frames via RdmaTransport callbacks.
