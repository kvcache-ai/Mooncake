...
public:
	...
	Status getTransferStatus(BatchID batch_id, std::vector<TransferStatus> &status);
...
public:
	static int selectDevice(SegmentDesc *desc, uint64_t offset, size_t length, int &buffer_id, int &device_id,
	                        int retry_cnt = 0);
