// test_musa_ipc.c — Test MUSA IPC handle exchange + P2P write
// Build: musacc test_musa_ipc.c -o test_musa_ipc -lmusart
// Or:    gcc test_musa_ipc.c -o test_musa_ipc -I/usr/local/musa/include -L/usr/local/musa/lib -lmusart
...
int test_same_process_ipc(void) {
    ...
    // Step 5: Write to peer memory from device 0
    int host_data[1024];
