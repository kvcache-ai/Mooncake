...
void dispatch(void* packed_recv_x, float* packed_recv_x_scales,
              ...
              const void* x,
              const int64_t* topk_idx, device::DeviceSignal* next_clean_buffer, int num_tokens,
              ...
              int phases, int active_qps_per_rank, device::DeviceComm device_comm);
...
void combine(void* combined_x, int32_t* active_ranks,
             ...
             const int64_t* layout_range, device::DeviceSignal* next_clean_buffer,
             ...
             bool zero_copy, int active_qps_per_rank, device::DeviceComm device_comm);
