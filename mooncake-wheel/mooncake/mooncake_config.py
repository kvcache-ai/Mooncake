...
- efa: AWS Elastic Fabric Adapter transport via libfabric
- cxi: HPE Slingshot/CXI transport via libfabric
...
or leave it empty to use auto-discovery.
...
class MooncakeConfig:
    ...
    Attributes:
        ...
        device_name (Optional[str]): The name of the RDMA device to use
            (e.g., "mlx5_0", "erdma_0"). Leave empty for auto-discovery.
            Optional when protocol is "rdma" and auto-discovery is enabled;
