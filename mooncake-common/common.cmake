...
option(USE_FLAGCX "option for using FlagCX-backed transport (cross-vendor CCL)" OFF)
if (USE_FLAGCX)
  if (NOT FLAGCX_HOME)
  ...
  if (NOT EXISTS "${FLAGCX_HOME}/include/flagcx.h")
    message(FATAL_ERROR "USE_FLAGCX=ON but flagcx.h not found under ${FLAGCX_HOME}/include (set -DFLAGCX_HOME=...)")
  endif()
  include_directories(${FLAGCX_HOME}/include)
  link_directories(${FLAGCX_HOME}/lib)
  add_compile_definitions(USE_FLAGCX)
  message(STATUS "FlagCX transport enabled, FLAGCX_HOME=${FLAGCX_HOME}")
endif()
