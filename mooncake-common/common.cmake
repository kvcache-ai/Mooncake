...
option(USE_NVLINK "option for using NVLink transport" ON)
option(USE_NVLINK_HOOK "option for building nvlink hook" ON)
...
if (USE_NVLINK_HOOK)
  add_compile_definitions(USE_NVLINK_HOOK)
  message(STATUS "NVLink hook building is enabled")
endif()
