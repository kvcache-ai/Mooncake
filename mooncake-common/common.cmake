...
option(USE_TPU "option for enabling pluggable TPU runtime support" OFF)
...
option(
  WITH_NVIDIA_PEERMEM
  "disable to support RDMA without nvidia-peermem. If WITH_NVIDIA_PEERMEM=OFF then USE_CUDA=ON is required."
  ON)
...
if(USE_TPU)
  ...
  message(STATUS "TPU support is enabled via runtime adapter")
endif()
...
if(USE_MACA)
  # MACA toolchain is CUDA-compatible in first-stage porting. Reuse CUDA code
  # paths to get a runnable baseline quickly.
  ...
  link_directories(${MACA_HOME}/lib ${MACA_HOME}/lib64)
endif()
