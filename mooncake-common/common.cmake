...
if(USE_SUPA)
  ...
  if(DEFINED ENV{SUPA_PATH})
    set(SUPA_ROOT "$ENV{SUPA_PATH}" CACHE PATH "Path to SUPA SDK")
  elseif(DEFINED ENV{BIREN_HOME})
    set(SUPA_ROOT "$ENV{BIREN_HOME}/supa" CACHE PATH "Path to SUPA SDK")
  else()
    set(SUPA_ROOT "/usr/local/birensupa/all/latest/supa" CACHE PATH "Path to SUPA SDK")
  endif()
  if(DEFINED ENV{BIREN_HOME})
    set(SUPA_DRIVER_LIB_DIR "$ENV{BIREN_HOME}/brumd/lib" CACHE PATH "Path to SUPA driver lib")
  else()
    set(SUPA_DRIVER_LIB_DIR "/usr/lib" CACHE PATH "Path to SUPA driver lib")
  endif()
  message(STATUS "  SUPA root: ${SUPA_ROOT}")
  message(STATUS "  SUPA driver lib: ${SUPA_DRIVER_LIB_DIR}")
  include_directories(${SUPA_ROOT}/include)
  link_directories(${SUPA_ROOT}/lib ${SUPA_DRIVER_LIB_DIR})
endif()
