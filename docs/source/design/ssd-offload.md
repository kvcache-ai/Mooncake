...
For durable `Remove` and `BatchRemove` handling in the bucket backend, including
tombstones, watermark-triggered reclamation, and multi-bucket compaction, see
[Reliable SSD Object Deletion and Bucket Garbage Collection](ssd-object-deletion-and-gc.md).
