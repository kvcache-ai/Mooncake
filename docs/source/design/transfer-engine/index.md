...
- `MC_AUTO_GID_MAX_RETRIES` The maximum number of automatic GID fallback retries during classic RDMA recovery. Default value 2. Set to 0 to disable automatic GID retry.
