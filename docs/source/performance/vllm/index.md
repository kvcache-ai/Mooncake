...
|----------|---------|---------------|
| [vLLM V1 + MooncakeStoreConnector](../vllm-v1-kvcache-sharing) | vLLM V1 | Distributed KV cache pool improves throughput by **3.8x**, reduces P50 TTFT and E2E latency by **46x** and **8.6x**, and scales to **60 GPUs** with >95% cache hit rate |
