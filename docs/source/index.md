...
- **Jun 20, 2025**: Mooncake becomes a PD disaggregation [backend](integrations/lmdeploy) for LMDeploy.
...
- **May 8, 2025**: [Mooncake x LMCache](integrations/lmcache) unite to pioneer KVCache-centric LLM serving system.
...
Mooncake x LMCache Integration<integrations/lmcache>
Mooncake x LMDeploy Integration<integrations/lmdeploy>
:::
...
- [Guide: vLLM MooncakeStoreConnector](integrations/vllm/vllm-mooncakestoreconnector)
- [vLLM V0 Disaggregated Serving Demo](integrations/vllm/vllm-integration-v0.2)
- [vLLM V0 Disaggregated Serving with MooncakeStore](integrations/vllm/vllm-integration-v0.3)
- [vLLM v1 backend Disaggregated Serving with MooncakeConnector](integrations/vllm/vllm-integration-v1.0)
