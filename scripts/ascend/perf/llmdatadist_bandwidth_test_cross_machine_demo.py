...
def link(datadist, device_id):
    rank_table_dict = {
        ...
        "server_list": [
            {
                "device": [{"device_id": str(device_id), "device_ip": PROMPT_IP_LIST[device_id], "rank_id": "0"}],
                "server_id": "1",
            },
            {
                "device": [{"device_id": str(device_id), "device_ip": DECODER_IP_LIST[device_id], "rank_id": "1"}],
                "server_id": "2",
            },
        ],
    }
