...
# Stage the migrated structured-object module and the legacy Reshard package for
# the combined-wheel builder. Each tracked source remains in its authoritative
# tree.
