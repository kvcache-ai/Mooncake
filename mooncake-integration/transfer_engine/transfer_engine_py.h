...
class TransferEnginePy {
   ...
   public:
    ...
    int registerMemoryBatch(std::vector<uintptr_t> buffer_addresses, std::vector<size_t> capacities);

    int unregisterMemoryBatch(std::vector<uintptr_t> buffer_addresses);
