...
- `MC_DISABLE_REUSEADDR` Force TCP deamon NOT to enable REUSEADDR option. This avoids rare cases that two processes use the same port. However, this prevents to reuse port after shutting down previous connections.
