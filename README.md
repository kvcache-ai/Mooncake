<div align="center">
  ...
  [![CUDA <=12.9](https://img.shields.io/badge/CUDA-%3C%3D12.9-supported-76B900)](https://pypi.org/project/mooncake-transfer-engine)
  [![CUDA 13.0/13.1](https://img.shields.io/badge/CUDA-13.0%2F13.1-supported-76B900)](https://pypi.org/project/mooncake-transfer-engine-cuda13)
...
- **Feb 25, 2026**: SGLang merged [Encoder Global Cache Manager](https://github.com/sgl-project/sglang/pull/16137), introducing a Mooncake-powered global multimodal embedding cache that enables cross-instance sharing of ViT embeddings to avoid redundant GPU computation.
