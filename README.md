...
<h2 id="updates">🔄 Updates</h2>
 ...
 - **Jan 28, 2026**: [FlexKV](https://github.com/taco-project/FlexKV) is a distributed KV store and multi-level cache management system jointly developed by teams from Tencent and NVIDIA in collaboration with the community. It currently implements the critical feature of [distributed KVCache reuse based on Mooncake Transport Engine](https://github.com/taco-project/FlexKV/blob/main/docs/dist_reuse/README_en.md).
