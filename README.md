...
Mooncake integrates with inference engines, middleware frameworks, and RL post-training systems across the LLM ecosystem — including **vLLM**, **SGLang**, **LMDeploy**, **TensorRT-LLM**, **Chitu**, **xLLM**, **RTP**, **KVCM**, **TBase**, **Dynamo**, **LMCache**, **TransferQueue**, **Slime/Miles**, **ROLL**, and **Verl**. See the [ecosystem support matrix](docs/source/design/ecosystem-support.md) for component-level adoption details (Transfer, Store, EP/Torch Backend, Ckpt Engine).

| <a href="https://github.com/vllm-project/vllm"><img src="image/software/vllm.png" width="120" alt="vLLM"/><br><sub>vLLM</sub></a> | <a href="https://github.com/sgl-project/sglang"><img src="image/software/sglang.png" width="120" alt="SGLang"/><br><sub>SGLang</sub></a> | <a href="https://github.com/InternLM/lmdeploy"><img src="image/software/lmdeploy.png" width="120" alt="LMDeploy"/><br><sub>LMDeploy</sub></a> | <a href="https://github.com/NVIDIA/TensorRT-LLM"><img src="image/software/tensorrt-llm.png" width="120" alt="TensorRT-LLM"/><br><sub>TensorRT-LLM</sub></a> | <a href="https://github.com/thu-pacman/chitu"><img src="image/software/chitu.png" width="120" alt="Chitu"/><br><sub>Chitu</sub></a> | <a href="https://github.com/jd-opensource/xllm"><img src="image/software/xllm.png" width="120" alt="xLLM"/><br><sub>xLLM</sub></a> |
| --- | --- | --- | --- | --- | --- |
| <a href="https://github.com/alibaba/rtp-llm"><img src="image/software/alibaba.png" width="120" alt="RTP"/><br><sub>RTP</sub></a> | <a href="https://github.com/alibaba"><img src="image/software/alibaba.png" width="120" alt="KVCM"/><br><sub>KVCM</sub></a> | <a href="https://github.com/antgroup"><img src="image/software/antgroup.png" width="120" alt="TBase"/><br><sub>TBase</sub></a> | <a href="https://github.com/ai-dynamo/dynamo"><img src="image/software/dynamo.png" width="120" alt="Dynamo"/><br><sub>Dynamo</sub></a> | <a href="https://github.com/LMCache/LMCache"><img src="image/software/lmcache.png" width="120" alt="LMCache"/><br><sub>LMCache</sub></a> | <a href="https://github.com/Ascend/TransferQueue"><img src="image/software/ascend.png" width="120" alt="TransferQueue"/><br><sub>TransferQueue</sub></a> |
| <a href="https://github.com/THUDM/slime"><img src="image/software/thudm.png" width="120" alt="Slime"/><br><sub>Slime/Miles</sub></a> | <a href="https://github.com/alibaba/ROLL"><img src="image/software/alibaba.png" width="120" alt="ROLL"/><br><sub>ROLL</sub></a> | <a href="https://github.com/volcengine/verl"><img src="image/software/volcengine.png" width="120" alt="Verl"/><br><sub>Verl</sub></a> | | | |
